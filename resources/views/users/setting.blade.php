                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/setting') }}">
                            ...
                            <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="city" type="text" class="form-control" value="{{isset(user()->settings['city']) ? user()->settings['city'] : ''}}" name="city" required>
                            ...
                            <div class="form-group{{ $errors->has('bio') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea name="bio" id="bio" class="form-control">{{isset(user()->settings['bio']) ? user()->settings['bio'] : ''}}</textarea>
                                    @if ($errors->has('bio'))
                                        <span class="help-block">
